...
| 6 | Is strict-dedicated (no PAYG backfill) offered at launch? | **Yes**, from GA (phase P1), at **1.3×** the base (Standard) CU price, regardless of tier. | [05 §6](05-isolation-and-scheduling.md#6-pool-tiers-hybrid-isolation) |
